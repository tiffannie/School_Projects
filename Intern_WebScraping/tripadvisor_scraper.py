#if I want to find hotals in Boston for 2017-jan-01 to 2017-Jan-02, sorted by popularity then
#run  python tripadvisor_scraper.py "2017/01/01" "2017/01/02" "popularity" "boston"
